...
C++ API
-------
.. cpp:function:: void AdjointAxpyContract( T alpha, const ElementalMatrix<T>& A, ElementalMatrix<T>& B )
.. cpp:function:: void AdjointAxpyContract( T alpha, const BlockMatrix<T>& A, BlockMatrix<T>& B )
